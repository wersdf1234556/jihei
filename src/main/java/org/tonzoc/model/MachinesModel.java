...
// 机械基础表
@Table("machines")
public class MachinesModel extends BaseModel {
    ...
    @JoinColumn(value = "name", type = MachineTypesModel.class, leftColumn = "machineTypeGuid", rightColumn = "guid")
    private String typeName;
    @JoinColumn(value = "name", type = MachineCategoriesModel.class, leftColumn = "machineCategoryGuid", rightColumn = "guid")
