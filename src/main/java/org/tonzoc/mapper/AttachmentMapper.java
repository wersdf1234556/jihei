...
public interface AttachmentMapper extends BaseMapper<AttachmentModel> {
    ...
    @Select("select guid from attachments where name = #{name} and typeGuid = #{typeGuid} and subTypeGuid = #{subTypeGuid}")
    String getGuid (String name, String typeGuid, String subTypeGuid);
