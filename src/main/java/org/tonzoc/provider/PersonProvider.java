...
public class PersonProvider {
    ...
    public String attendanceCount(@Param(value = "tenderGuid") String tenderGuid,
        ...
        StringBuilder stringBuilder = new StringBuilder("select tenders.guid tenderGuid, tenders.name tenderName, persons.guid guid, persons.name name, persons.idCard idCard, persons.mobile mobile, isnull(attendances.pcount,0) as trainNumber from persons" +
        ...
        stringBuilder.append(" order by attendances.pcount, tenders.sortid");
